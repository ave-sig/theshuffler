...
- Check that your system has the required tools
...
- Xcode Command Line Tools — the installer will tell you if these are missing or need updating. If prompted, run `xcode-select --install`, wait for the popup to say **Done** (this can take 5-10 minutes), restart your Mac, then run the installer again.
